...
public class WorkshopController {
    ...
    public String showUpdateForm(Model model
        ...
        WorkshopData workshopData = workshopService.getWorkshopData(workshopService.findByUsername(username));
...
//    }
    ...
    public String showOrders(Model model
        ...
        model.addAttribute("loginedWorkshop", workshopService.findByUsername(username));
        return "workshop/show-orders";
    }
    ...
    public String showOrderCreated(Model model
        ...
        model.addAttribute("orderDataAnswer", new OrderAnswerData());
        return "workshop/show-order-created";
    }


    @PostMapping("/processOrderCreate")
    public String processOrderCreate(
            @Valid @ModelAttribute("orderDataAnswer") OrderAnswerData orderAnswerData,
            BindingResult bindingResult,
            Model model) {
       orderAnswerService.createWorkshopRepeatOrderAnswer(orderAnswerData);
        return "redirect:/";
        // form validation
//        if (bindingResult.hasErrors()) {
//            model.addAttribute("wrapperString", wrapperString);
